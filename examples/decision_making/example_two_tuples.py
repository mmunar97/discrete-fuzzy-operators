...
if __name__ == "__main__":
    ...
    # EXAMPLE 2: Determination of the best alternative among different expert assessments.
    two_tuples_set1 = [TwoTuple(label_index=4, alpha=0, context=term_set),
                       TwoTuple(label_index=3, alpha=0, context=term_set),
                       TwoTuple(label_index=1, alpha=0, context=term_set),
                       TwoTuple(label_index=4, alpha=0, context=term_set),
                       TwoTuple(label_index=0, alpha=0, context=term_set)]

    two_tuples_set2 = [TwoTuple(label_index=1, alpha=0, context=term_set),
                       TwoTuple(label_index=0, alpha=0, context=term_set),
                       TwoTuple(label_index=4, alpha=0, context=term_set),
                       TwoTuple(label_index=1, alpha=0, context=term_set),
                       TwoTuple(label_index=3, alpha=0, context=term_set)]

    two_tuples_set3 = [TwoTuple(label_index=1, alpha=0, context=term_set),
                       TwoTuple(label_index=4, alpha=0, context=term_set),
                       TwoTuple(label_index=4, alpha=0, context=term_set),
                       TwoTuple(label_index=2, alpha=0, context=term_set),
                       TwoTuple(label_index=4, alpha=0, context=term_set)]

    two_tuples_set4 = [TwoTuple(label_index=2, alpha=0, context=term_set),
                       TwoTuple(label_index=4, alpha=0, context=term_set),
                       TwoTuple(label_index=0, alpha=0, context=term_set),
                       TwoTuple(label_index=3, alpha=0, context=term_set),
                       TwoTuple(label_index=4, alpha=0, context=term_set)]

    two_tuples_set5 = [TwoTuple(label_index=1, alpha=0, context=term_set),
                       TwoTuple(label_index=2, alpha=0, context=term_set),
                       TwoTuple(label_index=1, alpha=0, context=term_set),
                       TwoTuple(label_index=2, alpha=0, context=term_set),
                       TwoTuple(label_index=4, alpha=0, context=term_set)]

    two_tuples_set6 = [TwoTuple(label_index=3, alpha=0, context=term_set),
                       TwoTuple(label_index=4, alpha=0, context=term_set),
                       TwoTuple(label_index=3, alpha=0, context=term_set),
                       TwoTuple(label_index=4, alpha=0, context=term_set),
                       TwoTuple(label_index=2, alpha=0, context=term_set)]

    print("EXAMPLE 2: Aggregation of the assessments using arithmetic mean aggregation")
    print(two_tuple_arithmetic_mean_aggregation(tuples=two_tuples_set1))
    print(two_tuple_arithmetic_mean_aggregation(tuples=two_tuples_set2))
    print(two_tuple_arithmetic_mean_aggregation(tuples=two_tuples_set3))
    print(two_tuple_arithmetic_mean_aggregation(tuples=two_tuples_set4))
    print(two_tuple_arithmetic_mean_aggregation(tuples=two_tuples_set5))
    print(two_tuple_arithmetic_mean_aggregation(tuples=two_tuples_set6))

    # EXAMPLE 3: Aggregation of tuples using weighted averaging
    ...
    print("EXAMPLE 3: Aggregation of tuples using weighted averaging")
